...
namespace Feeder.MB.Core
{
    ...
    /// </summary>
    [CreateAssetMenu(fileName = "MeshAssignCustomizerSimpleAPIPutSliceIdxInUV0_z", menuName = "Feeder MB/Assign To Mesh Customizer/Simple API Put Slice Index In UV0.z", order = 1)]
