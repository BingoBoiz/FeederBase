...
namespace Feeder.MB.Core
{
    ...
    /// </summary>
    [CreateAssetMenu(fileName = "MeshAssignCustomizerNativeArrayPutSliceIdxInUV0_z", menuName = "Feeder MB/Assign To Mesh Customizer/NativeArray API Put Slice Index In UV0.z", order = 1)]
