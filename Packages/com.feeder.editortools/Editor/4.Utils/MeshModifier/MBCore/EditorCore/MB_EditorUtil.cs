...
{
    public const string MESH_BAKER_WORKING_FOLDER_NAME = "FeederMeshModifier_Working";

    public static string GetShortPathToWorkingDirectoryAndEnsureItExists()
    {
        string workingFolder = "Assets/" + MESH_BAKER_WORKING_FOLDER_NAME;
        if (!AssetDatabase.IsValidFolder(workingFolder))
        {
            AssetDatabase.CreateFolder("Assets", MESH_BAKER_WORKING_FOLDER_NAME);
        }
